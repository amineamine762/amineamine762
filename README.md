...
- 🎓 Student in **Digital Engineering, specializing in Data Science & AI** at **ENSAM Rabat**  
- 💡 Open to **Data Science**, including **data preprocessing, cleaning, and visualization**  
- 🤖 Interested in **building intelligent systems** using **Machine Learning and Deep Learning**  
- 🧠 Passionate about **problem solving** and applying AI to real-world challenges
...
- [**Graphical Method Python**](https://github.com/amineamine762/Graphical-Method-Python)  
  Implementation of the **graphical method for linear programming** in Python.  
  Solve optimization problems and visualize feasible regions and solutions.
